...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    e.preventDefault();
    setLoading(true);
    emailjs.send('service_gi7oemu','template_m0ek4gp', {from_name: form.name, to_name:'Sangmitra', from_email: form.email, to_email:'sangmitra.m06@gmail.com', message:form.message}, 'BKs8oRxudAlqP5sqb' ).then(()=>{
      setLoading(false); alert('Thank you for your email, I will get back to you soon :)'); setForm({name:'', email:'', message:''});
