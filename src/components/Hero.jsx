  ...
  return (
    <section className='relative w-full h-screen mx-auto'>
      <div className={` ${styles.paddingX} absolute inset-0 top-[90px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>Hi I am <span className='text-[#915eff]'>Sangmitra</span></h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}> I am a software developer and an <br className = 'sm:block hidden' />IBM Certified Full Stack Developer </p>
        </div>
